...
export async function resetDBMeta(connectionName = 'MASTER_CONNECTION') {
  ...
  // const sqlPaths = [
  //   path.resolve(__dirname, '../../../_db_schema/seed_demo_1.sql'),
  //   path.resolve(__dirname, '../../../_db_schema/seed_demo_2.sql'),
  //   path.resolve(__dirname, '../../../_db_schema/seed_demo_3.sql'),
  //   path.resolve(__dirname, '../../../_db_schema/seed_demo_4.sql'),
  //   path.resolve(__dirname, '../../../_db_schema/seed_demo_5.sql'),
  //   path.resolve(__dirname, '../../../_db_schema/seed_demo_6.sql'),
  // ];

  // for (const i in sqlPaths) {
  //   const sqlPath = sqlPaths[i];
  //   const query = fs
  ...
  //   if (Number(i) == 0) query.replace("', 'demo', ',", `', '${NODE_ENV}', ',`);

  //   if (!query) continue;

  //   console.log(`resetDBMeta - ${i}`, query);
