...
import { OemNotificationsModule } from './oem/main/oem-notifications/oem-notifications/oem-notifications.module';
...
import { OemThirdPartyTokenController } from './oem/integrations/third-party-token/third-party-token.controller';
import { OemRuleActionsModule } from './oem/main/oem-rules/oem-rule-actions/oem-rule-actions.module';
...
@Module({
  imports,
  controllers: [OemThirdPartyTokenController],
  providers,
})
