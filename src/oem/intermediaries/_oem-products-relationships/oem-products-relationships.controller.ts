...
import { dto, serialize } from './oem-products-relationships.dto';
...
@Crud({
  ...
  query: {
    join: {
      ...
      'targetProduct.priceTiers': {
        eager: false,
        alias: 'priceTiers',
      },
      'targetProduct.priceTiers.unitTier': {
        eager: false,
      },
      ...
      'sourceProduct.priceTiers': {
        eager: false,
      },
      'sourceProduct.priceTiers.unitTier': {
        eager: false,
      },
    },
  },
