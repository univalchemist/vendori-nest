...
@Index(
  'oem_quote_and_vendo_uuid_id_idx',
  ['companyId', 'quoteAndVendoUuidId'],
  {},
)
@Index('oem_quote_and_vendo_uuid_company_id_idx', ['companyId'], {})
@Index('oem_quote_and_vendo_uuid_last_uuid_idx', ['lastUuid', 'companyId'], {})
@Entity('oem_quote_and_vendo_uuids', { schema: 'oem' })
export class QuoteAndVendoUuid {
  @PrimaryColumn({ type: 'integer', name: 'quote_and_vendo_uuid_id' })
  quoteAndVendoUuidId: number;
