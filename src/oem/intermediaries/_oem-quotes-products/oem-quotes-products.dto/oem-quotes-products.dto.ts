...
import { SfProductMetadataDto } from '../../../../shared/salesforce/salesforce.dto.metadata/product.metadata.dto';

export class QuotesProductsDto extends SfProductMetadataDto {
  /**
   * The id of Product
   * @example 1
   */
