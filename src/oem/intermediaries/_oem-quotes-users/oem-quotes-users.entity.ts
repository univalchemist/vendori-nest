...
import { SfQuoteContactMetadataEntity } from '../../../shared/salesforce/salesforce.entities.metadata/quote-user.metadata.entity';
...
export class QuotesUsers extends SfQuoteContactMetadataEntity {
  ...
  @Column('boolean', { name: 'show_on_pdf', default: true })
  showOnPDF: boolean;

  @Column('boolean', { name: 'send_notification', default: true })
