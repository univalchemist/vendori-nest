    ...
    try {
      ...
      return this.repo.manager.transaction(async (manager) => {
        ...
        const billingAddressData = {
          address_1: `${!!BillingStreet ? BillingStreet : '-'}`,
          address_2: '-',
          address_3: '-',
          city: `${!!BillingCity ? BillingCity : '-'}`,
          region: `${!!BillingState ? BillingState : '-'}`,
          zipCode: `${!!BillingPostalCode ? BillingPostalCode : '-'}`,
          country: `${
        ...
        const shippingAddressData = {
          address_1: `${!!ShippingStreet ? ShippingStreet : '-'}`,
          address_2: '-',
          address_3: '-',
          city: `${!!ShippingCity ? ShippingCity : '-'}`,
          zipCode: `${!!ShippingPostalCode ? ShippingPostalCode : '-'}`,
          region: `${!!ShippingState ? ShippingState : '-'}`,
          country: `${
        ...
        let customer: Partial<OemCustomerEntity> = await manager.findOne(
          OemCustomerEntity,
          {
            where: { salesOrganizationId: customerData.salesOrganizationId },
          },
        );
        ...
        await this.salesforceService.setCustomerIdSF(
          salesOrganizationId,
          customer.customerId,
          companyId,
        );
