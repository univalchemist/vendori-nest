...
import { SfQuoteMetadataEntity } from '../../../shared/salesforce/salesforce.entities.metadata/quote.metadata.entity';
...
@Index('oem_quotes_quote_uuid_key', ['companyId', 'quoteUuid'], {
  unique: true,
})
@Index('oem_quotes_expires_at_idx', ['expiresAt'], {})
@Entity('oem_quotes', { schema: 'oem' })
export class Quote extends SfQuoteMetadataEntity {
