...
export class OemCompanyDto {
  ...
  /**
   * The template type of quote pdf.
   * 'Landscape', 'ColoredLandscape', 'Portrait', 'ColoredPortrait'
   * @example 'Landscape'
   */
  @IsEnum(QuoteTemplateEnum)
  ...
  @ApiProperty({
    type: SettingsType,
    default: {
      quoteTemplateType: 'Portrait with no color',
