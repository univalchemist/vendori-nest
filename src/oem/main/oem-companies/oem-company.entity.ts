...
export class Company {
  ...
  @Column('jsonb', {
    ...
    array: false,
    default: () =>
      '\'{"quoteTemplateType": "Portrait with no color","companyPrimaryColor":{"a":1,"b":187,"g":137,"r":74},"customListPriceName":"List Price","defaultPaymentTerms": "30","startingQuoteNumber": 1,"customCustomerPriceName":"Price To Customer"}\'',
    nullable: false,
  })
  ...
  @Column('enum', {
    name: 'quote_template',
    enum: QuoteTemplateEnum,
    default: QuoteTemplateEnum.COLORED_LANDSCAPE,
  })
