...
import { SfUserMetadataDto } from '../../../../shared/salesforce/salesforce.dto.metadata/user.metadata.dto';

export class OemUserDto extends SfUserMetadataDto {
   ...
   */
  // @IsUrl()
  @Matches(/^http(s|):\/\/.+(\.|).+\..[a-z]{1,15}.*$/, {
    message: `Please specify a valid image URL`,
  })
  @MaxLength(1024)
  @IsOptional()
   ...
   */
  @Matches(/^[A-Za-z0-9\-\'\.]+$/, {
    message: `The first name should contain alphanumeric characters and these three symbols - ' and .`,
  })
  @MaxLength(128)
  firstName: string;
   ...
   */
  @Matches(/^[A-Za-z0-9\-\'\.]+$/, {
    message: `The last name should contain alphanumeric characters and these three symbols - ' and .`,
  })
  @MaxLength(128)
  lastName: string;
   ...
   */
  @MaxLength(256)
  @Matches(/^[\_\-.+0-9a-z]{1,90}@[^\.]{1,90}\.[a-z]{1,15}(\.[a-z]{1,15}|)$/i, {
